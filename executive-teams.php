...
<div
   ...
   <div
      ...
      <button
         id="closeTeamModal"
         class="absolute top-4 right-4 text-2xl text-gray-500 hover:text-[var(--primary)] z-10">
      ...
      <div class="grid lg:grid-cols-[350px_1fr]">
         ...
         <div class="p-8">
            <span
               ...
               class="inline-flex px-3 py-1 rounded-full bg-primary/10 text-[var(--primary)] text-sm font-medium mb-4">
            </span>
            <h3
               id="modalTeamName"
               class="mb-4">
