   ...
   <div class="container">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
         ...
         <div data-aos="fade-right">
            <img
               src="./assets/images/biography/overview.jpg"
               alt="Leadership Legacy" loading="lazy"
         ...
         <div data-aos="fade-left">
            ...
            <p class="text-muted leading-relaxed mb-5">
               Behind every successful initiative are individuals whose
               dedication, leadership, and commitment have contributed
               to strengthening volunteerism and sustainable development.
            </p>
            <p class="text-muted leading-relaxed mb-8">
               These biographies preserve the experiences,
               achievements, and contributions of leaders who continue
               to inspire future generations of volunteers and
